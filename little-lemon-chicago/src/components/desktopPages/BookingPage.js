...
import {
  initialValues,
  userSchema,
} from '../../helpers/userSchemaAndInitialValues'
...
const BookingPage = () => {
  ...
  const initialFormikValues = {
    ...
    time: bookingSel.time
      ? dayjs(bookingSel.time, 'HH:mm').format('HH:mm')
      : '',
  }
                ...
                <SemanticForm as={Form}>
                  ...
                  <SemanticForm.Field>
                    ...
                    <Datepicker
                      ...
                      onChange={(dates) => {
                        ...
                        if (start) {
                          const formattedDate =
                            bookingSel.dat.format('YYYY-MM-DD')
                  ...
                  <SemanticForm.Field>
                    ...
                    >
                      ...
                      <option
                        onChange={(e) =>
                          handleFieldChange('occasion', 'birthday')
                        }
                        value="birthday"
                      >
                        Birthday
                      ...
                      <option
                        onChange={(e) =>
                          handleFieldChange('occasion', 'anniversary')
                        }
                        value="anniversary"
                      >
                        Anniversary
                      ...
                      <option
                        onChange={(e) => handleFieldChange('occasion', 'other')}
                        value="other"
                      >
                        Other
                      </option>
