...
const Main = ({ handleClickOrderOnlineCard, refAddedToBasket }) => {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener('resize', handleResizeOrLocationChange)
  }, [
    location.pathname,
    dispatch,
    isMobile,
    ...
    <main id="main_main" className={styles.main}>
      <Routes>
        <Route
          path="/"
          element={
            <HomePage handleClickOrderOnlineCard={handleClickOrderOnlineCard} />
          }
        />
        ...
        <Route
          path="/menu/*"
          element={pageSel.isMobile ? <MenuMobile /> : <MenuPage />}
        />
        <Route
          path="/about"
          element={pageSel.isMobile ? <AboutMobile /> : <AboutPage />}
        />
        <Route
          path="/order_online/*"
          element={
      ...
      <div
        ref={refAddedToBasket}
        className="added_to_basket"
        aria-live="polite"
      >
